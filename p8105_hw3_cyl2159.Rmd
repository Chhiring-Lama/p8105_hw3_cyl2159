...
Although the changes in activity per participant is hard to follow through, with smooth trends, we can see that activity level of people in all three education categories peak at around mid-day. Women with at least high school education in general have higher activity level than their male counterparts during the day. 
...
In total, for each of the four different month and year combinations. Citi Bike members had higher total number of bike rides compared to casual riders. We can see that both the number of casual and member rides (and the total ride duration) have increased in 2024 when compared to the same months in 2020. However, on average casual bike members use the bike for longer period of time than members. This could be because the member bike riders likely use them for regular commute whereas casual riders use it recreationally. 
